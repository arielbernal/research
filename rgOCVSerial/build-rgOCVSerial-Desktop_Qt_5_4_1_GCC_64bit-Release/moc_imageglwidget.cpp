...
#include "../rgOCVSerial/ocvTools/imageglwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ImageGLWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ImageGLWidget_t qt_meta_stringdata_ImageGLWidget = {
    {
QT_MOC_LITERAL(0, 0, 13) // "ImageGLWidget"
...
const QMetaObject ImageGLWidget::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_ImageGLWidget.data,
      qt_meta_data_ImageGLWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
