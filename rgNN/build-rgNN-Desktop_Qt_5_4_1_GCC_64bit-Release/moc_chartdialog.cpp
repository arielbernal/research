...
#include "../common/qtTools/chartdialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ChartDialog_t, stringdata) + ofs \
...
void *ChartDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ChartDialog.stringdata))
